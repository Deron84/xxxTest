Ext.onReady(function() {
	...
	var brhColModel = new Ext.grid.ColumnModel([
		...
		{header: '工具类型',dataIndex: 'toolType',sortable: true,/*renderer: brhLvlRender,*/width: 90,},
		{header: '工具名称',dataIndex: 'toolName',sortable: true,/*renderer: brhLvlRender,*/width: 90,},
		{header: '工具型号',dataIndex: 'toolModel',sortable: true,/*renderer: brhLvlRender,*/width: 90,},
		...
		var excelQueryForm = new Ext.form.FormPanel({
			...
			buttons: [{
				...
				handler: function() {
					...
					var param = "?a=1";
					param = pram + "&txnId=excel&subTxnId=110301"//日志用
					if(dateStart){
					...
					window.location.href = Ext.contextPath +"/exportExcelT1103.asp"+param;
					excelDown.hide();
				}
			},{
				text: '取消导出',
