Ext.onReady(function() {
	...
	var txnStore = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({
			url: 'gridPanelStoreAction.asp?storeId=mchtAlgoInfoCount'
		}),
...
//		{header: '清算日期',dataIndex: 'DATE_SETTLMT',width: 80},
		...
		//{header: '卡类型',dataIndex: 'cardType',width: 80},
		{header: '计费代码',dataIndex: 'mchtFeeTp',width: 80},
		{header: '交易笔数',dataIndex: 'transCount',align : 'right'},
		{header: '交易金额(元)',dataIndex: 'trans_amt',align : 'right'},
		{header: '手续费(元)',dataIndex: 'transFee',align : 'right'},
		{header: '清算金额(元)',dataIndex: 'settl_amt',align : 'right'},
		{header: '收单收入(元)',dataIndex: 'amtIn',align : 'right'}
	]);
