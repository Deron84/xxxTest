Ext.onReady(function() {
	...
	var editMenu = {
		...
		handler : function() {
            ...
            Ext.Ajax.request({
				url : 'T130500Action_getData.asp',
				params : {
					workCode : selectedRecord.get('warnId')
				},
				success : function(rsp, opt) {
					...
					if(rspObj.success) {
			            ...
			            Ext.getCmp('workCodeUp').setValue(rspObj.msg.workCode);
            ...
            handler: function() {
            	if(updTermForm.getForm().isValid()) {
					...
					updTermForm.getForm().submit({
						url: 'T130500Action.asp?method=edit',
						waitMsg: '正在提交，请稍后......',
	            ...
	            Ext.Ajax.request({
					...
					success : function(rsp, opt) {
						...
						if(rspObj.success) {
				            ...
				            Ext.getCmp('infoSignDet').setValue(infoSignRender(rspObj.msg.infoSign));
	...
	var excelQueryForm = new Ext.form.FormPanel({
		...
		buttons: [{
			...
			handler: function() {
				...
				window.location.href = Ext.contextPath +"/exportExcelT130500.asp"+param;
				excelDown.hide();
...
//	menuArr.push('-');
	...
	var termStore = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            url: 'gridPanelStoreAction.asp?storeId=railWorkWarn'
        }),
...
//    	new Ext.grid.RowNumberer(),
    	...
    	{id:'workCode',header: '工单编码',dataIndex: 'workCode',sortable: true,width: 100},
    	{header: '工单名称',dataIndex: 'workName',sortable: true,width: 100},
		{header: '预警类型',dataIndex: 'warnType',sortable: true,width: 100},
		{header: '预警内容',dataIndex: 'warnMsg',sortable: true,width: 150},
		{header: '是否确认',dataIndex: 'infoSign',sortable: true,width: 90},
		{header: '预警时间',dataIndex: 'addDate',sortable: true,width: 150},
		{header: '操作备注',dataIndex: 'verifyMsg',sortable: true,width: 150},
		{header: '操作员',dataIndex: 'verifyUser',sortable: true,width: 120},
