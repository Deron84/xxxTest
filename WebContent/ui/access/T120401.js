            ...
            handler: function() {
            	if(updTermForm.getForm().isValid()) {
					...
					updTermForm.getForm().submit({
						url: 'T120401Action.asp?method=edit',
						waitMsg: '正在提交，请稍后......',
	...
	var excelQueryForm = new Ext.form.FormPanel({
		...
		buttons: [{
			...
			handler: function() {
				...
				window.location.href = Ext.contextPath +"/exportExcelT120401.asp"+param;
				excelDown.hide();
...
//	menuArr.push('-');
	...
	var termStore = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            url: 'gridPanelStoreAction.asp?storeId=railAccessMaintainWarn'
        }),
	...
	var termColModel = new Ext.grid.ColumnModel([
		...
		{header: '是否确认',dataIndex: 'infoSign',sortable: true,renderer: infoSignRender,width: 100},
		{header: '预警时间',dataIndex: 'addDate',sortable: true,width: 150},
		{header: '操作备注',dataIndex: 'verifyMsg',sortable: true,width: 200},
