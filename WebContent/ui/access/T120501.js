	...
	var excelQueryForm = new Ext.form.FormPanel({
		...
		buttons: [{
			...
			handler: function() {
	            ...
	            var equipCode =  queryForm.getForm().findField("equipCode").getValue();
	            var infoSign = '2';
				var param = "?a=1";
				if(accessCode){
				...
				window.location.href = Ext.contextPath +"/exportExcelT120502.asp"+param;
				excelDown.hide();
...
//				});
    ...
    termStore.on('beforeload', function() {
        Ext.apply(this.baseParams, {
            ...
            equipCode: queryForm.getForm().findField("equipCode").getValue(),
            infoSign:'2'
        });
    });
	...
	var termColModel = new Ext.grid.ColumnModel([
    	...
    	{id:'accessCode',header: '门禁编码',dataIndex: 'accessCode',sortable: true,width: 80},
		{header: '门禁名称',dataIndex: 'accessName',sortable: true,width: 100},
		{header: '设备编码',dataIndex: 'equipCode',sortable: true,width: 80},
		{header: '设备名称',dataIndex: 'equipName',sortable: true,width: 100},
		{header: '员工标识',dataIndex: 'employeeCode',sortable: true,width: 80},
		{header: '员工名称',dataIndex: 'employeeName',sortable: true,width: 80},
		{header: '工单标识',dataIndex: 'workCode',sortable: true,width: 80},
		{header: '工单名称',dataIndex: 'workName',sortable: true,width: 100},
		{header: '出入类型',dataIndex: 'infoSign',sortable: true,width: 80},
		{header: '开启状态',dataIndex: 'openSign',sortable: true,width: 80},
		{header: '创建时间',dataIndex: 'addDate',sortable: true,width: 120},
