...
//                queryWin.hide();
	...
	rowExpander,
		...
		{id: 'actNo',header: '活动编号',dataIndex: 'actNo'},
		{header: '活动名称',dataIndex: 'actName',width: 300},
		...
		{header: '截止日期',dataIndex: 'endDate',renderer: dateState}
//		,
...
//		{header: '自动清算业务种类编号',dataIndex: 'organType',width: 150}
	...
	var mchntColModel = new Ext.grid.ColumnModel([
		...
		{id: 'mchntNo',header: '商户号',dataIndex: 'mchntNo',width: 250},
