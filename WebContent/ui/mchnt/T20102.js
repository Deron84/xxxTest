Ext.onReady(function() {
	...
	var mchntColModel = new Ext.grid.ColumnModel([
		...
		{header: '商户号1',dataIndex: 'mappingMchntcdOne',width: 120},
		{header: '商户号2',dataIndex: 'mappingMchntcdTwo',width: 120},
		{header: '连接类型',dataIndex: 'connType',width: 60,id: 'connType',renderer : transConnType},
		...
		{header: '终端数量',dataIndex: 'termCount',width: 100}
	]);
