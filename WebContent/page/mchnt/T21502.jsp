...
<title>商户优惠规则绑定</title>
<script type="text/javascript"
	src="<%= request.getContextPath()%>/ext/ux/RowExpander.js"></script>
<script type="text/javascript"
	src="<%= request.getContextPath()%>/ext/ux/LovCombo.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="<%= request.getContextPath()%>/ui/mchnt/T21502.js"></script>
...
<link rel="stylesheet" type="text/css"
	href="<%= request.getContextPath()%>/ext/resources/css/LovCombo.css">
<script>
		var disid = '<%=request.getParameter("discountId") %>';
		if(disid=='null'){
			disid='';
		}
</script>
