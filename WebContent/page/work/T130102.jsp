...
<link href="<%=request.getContextPath()%>/ext/ux/Spinner.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="<%= request.getContextPath()%>/ui/work/T130102.js"></script>
