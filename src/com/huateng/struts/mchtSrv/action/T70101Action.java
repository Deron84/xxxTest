 ...
 * @version 1.0
 */
public class T70101Action extends BaseSupport{
	...
	public String pdf(){
		...
		try {
			...
			path += paperId;
			path += CommonFunction.fillString(String.valueOf(new Random().nextInt(9999)), '0', 4, true);
			path += ".pdf";
