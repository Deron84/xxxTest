...
public class T80911Action extends ReportBaseAction{
...
//		parameters.put("P_1", brhId + " - " +InformationUtil.getBrhName(brhId));
		...
		reportCreator.initReportData(getJasperInputSteam("T80911.jasper"), parameters, 
				reportModel.wrapReportDataSource(), getReportType());
		
		if(Constants.REPORT_EXCELMODE.equals(reportType))
			fileName = SysParamUtil.getParam(SysParamConstants.TEMP_FILE_DISK) + "RN80911RN_" + 
		...
		reportCreator.exportReport(outputStream, SysParamUtil.getParam("RN80911RN"));
	...
	protected String genSql() {
		...
		sb.append(" WHERE a.STLM_FLG='1' and b.agr_br in " + operator.getBrhBelowId());
