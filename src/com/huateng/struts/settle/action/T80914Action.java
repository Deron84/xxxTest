...
public class T80914Action extends ReportBaseAction{
...
//		parameters.put("P_1", brhId + " - " +InformationUtil.getBrhName(brhId));
		...
		reportCreator.initReportData(getJasperInputSteam("T80914.jasper"), parameters, 
				reportModel.wrapReportDataSource(), getReportType());
		
		if(Constants.REPORT_EXCELMODE.equals(reportType))
			fileName = SysParamUtil.getParam(SysParamConstants.TEMP_FILE_DISK) + "RN80914RN_" + 
		...
		reportCreator.exportReport(outputStream, SysParamUtil.getParam("RN80914RN"));
	...
	protected String genSql() {
		...
		sb.append("SELECT DATE_SETTLMT,MCHT_CD," +
						...
						"c.SETTLE_ACCT,c.SETTLE_ACCT_NM," +
				 		...
				 		"(case a.STLM_FLG when '2' then '套现' when '3' then '移机' end) risk " +
		...
		sb.append(" WHERE a.STLM_FLG in('2','3') and b.agr_br in " + operator.getBrhBelowId());
		...
		sb.append(" group by DATE_SETTLMT,MCHT_CD,b.agr_br,c.SETTLE_ACCT,c.SETTLE_ACCT_NM,a.STLM_FLG " +
