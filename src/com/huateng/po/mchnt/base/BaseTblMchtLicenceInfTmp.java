 ...
 *
 * @hibernate.class
 *  table="TBL_MCHT_LICENCE_INF_TMP"
 */

public abstract class BaseTblMchtLicenceInfTmp  implements Serializable {

	public static String REF = "TblMchtLicenceInfTmp";
	...
	// constructors
	public BaseTblMchtLicenceInfTmp () {
		initialize();
	}
	 ...
	 */
	public BaseTblMchtLicenceInfTmp (String licenceNo) {
