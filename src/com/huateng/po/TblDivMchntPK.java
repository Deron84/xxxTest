...
public class TblDivMchntPK implements Serializable {
	...
	public TblDivMchntPK(String mchtId, String divNo, String productCode) {
		super();
		this.mchtId = mchtId;
		this.divNo = divNo;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.TblDivMchntPK)) return false;
		else {
			com.huateng.po.TblDivMchntPK mObj = (com.huateng.po.TblDivMchntPK) obj;
			...
			if (null != this.getProductCode() && null != mObj.getProductCode()) {
				if (!this.getProductCode().equals(mObj.getProductCode())) {
					return false;
				}
			}
			else {
	...
	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			...
			if (null != this.getProductCode()) {
				sb.append(this.getProductCode().hashCode());
				sb.append(":");
			}
			else {
				return super.hashCode();
