...
public class TblTermRefuse implements Serializable {
	...
	// primary key
	private com.huateng.po.TblTermRefusePK id;
	 ...
	 * @hibernate.id
	 */
	public com.huateng.po.TblTermRefusePK getId() {
		return id;
	}
	 ...
	 *            the new ID
	 */
	public void setId(com.huateng.po.TblTermRefusePK id) {
		this.id = id;
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.po.TblTermRefuse))
			return false;
		else {
			com.huateng.po.TblTermRefuse tblTermRefuse = (com.huateng.po.TblTermRefuse) obj;
			if (null == this.getId() || null == tblTermRefuse.getId())
				return false;
			else
				return (this.getId().equals(tblTermRefuse.getId()));
		}
	}
