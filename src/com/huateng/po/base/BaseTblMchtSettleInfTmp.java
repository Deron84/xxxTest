...
/**
 * This is an object that contains data related to the TBL_MCHT_SETTLE_INF_TMP table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="TBL_MCHT_SETTLE_INF_TMP"
 */

public abstract class BaseTblMchtSettleInfTmp  implements Serializable {

	public static String REF = "TblMchtSettleInfTmp";
	...
	// constructors
	public BaseTblMchtSettleInfTmp () {
		initialize();
	}
	 ...
	 */
	public BaseTblMchtSettleInfTmp (java.lang.String mchtNo) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.mchnt.TblMchtSettleInfTmp)) return false;
		else {
			com.huateng.po.mchnt.TblMchtSettleInfTmp tblMchtSettleInfTmp = (com.huateng.po.mchnt.TblMchtSettleInfTmp) obj;
			if (null == this.getMchtNo() || null == tblMchtSettleInfTmp.getMchtNo()) return false;
			else return (this.getMchtNo().equals(tblMchtSettleInfTmp.getMchtNo()));
		}
	}
