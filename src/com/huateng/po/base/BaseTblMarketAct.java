...
/**
 * This is an object that contains data related to the TBL_MARKET_ACT table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="TBL_MARKET_ACT"
 */

public abstract class BaseTblMarketAct  implements Serializable {

	public static String REF = "TblMarketAct";
	 ...
	 */
	public BaseTblMarketAct (java.lang.String actNo) {
		this.setActNo(actNo);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.mchtSrv.TblMarketAct)) return false;
		else {
			com.huateng.po.mchtSrv.TblMarketAct tblMarketAct = (com.huateng.po.mchtSrv.TblMarketAct) obj;
			if (null == this.getActNo() || null == tblMarketAct.getActNo()) return false;
			else return (this.getActNo().equals(tblMarketAct.getActNo()));
		}
	}
