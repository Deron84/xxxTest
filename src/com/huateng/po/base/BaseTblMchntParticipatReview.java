...
/**
 * This is an object that contains data related to the TBL_MCHNT_PARTICIPAT_REVIEW table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="TBL_MCHNT_PARTICIPAT_REVIEW"
 */

public abstract class BaseTblMchntParticipatReview  implements Serializable {

	public static String REF = "TblMchntParticipatReview";
	...
	// constructors
	public BaseTblMchntParticipatReview () {
		initialize();
	}
	 ...
	 */
	public BaseTblMchntParticipatReview (com.huateng.po.mchtSrv.TblMchntParticipatReviewPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.huateng.po.mchtSrv.TblMchntParticipatReviewPK id;
     ...
     * @hibernate.id
     */
	public com.huateng.po.mchtSrv.TblMchntParticipatReviewPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.huateng.po.mchtSrv.TblMchntParticipatReviewPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.po.mchtSrv.TblMchntParticipatReview)) return false;
		else {
			com.huateng.po.mchtSrv.TblMchntParticipatReview tblMchntParticipatReview = (com.huateng.po.mchtSrv.TblMchntParticipatReview) obj;
			if (null == this.getId() || null == tblMchntParticipatReview.getId()) return false;
			else return (this.getId().equals(tblMchntParticipatReview.getId()));
		}
	}
