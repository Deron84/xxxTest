...
public class T50101Action extends BaseExcelQueryAction {
    ...
    protected void deal() {
        ...
        try {
            queryRepInfo = gridCfg.getPosTxnInfo(0, request);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        fillData2(statInfoList, statInfo2List, columnStr, "银联卡交易查询", "银联卡交易查询", 20, null);
    }
