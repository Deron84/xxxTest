...
public class RailToolInfoVo2 {
	...
	private List<String> tooCodes;
	private List<String>  infoSigns;
	
	private String location;
	private List<String> locations;

	public RailToolInfoVo2() {
		super();
	}

	public RailToolInfoVo2(long id, String toolCode, String toolName, String toolImg, String rfid, String modelCode,
	...
	public List<String> getTooCodes() {
		return tooCodes;
	}

	public void setTooCodes(List<String> tooCodes) {
		this.tooCodes = tooCodes;
	}

	public List<String> getInfoSigns() {
		return infoSigns;
	}

	public void setInfoSigns(List<String> infoSigns) {
	...
	public RailToolInfoVo2(long id, String toolCode, String toolName, String toolImg, String rfid) {
		super();
		this.id = id;
		this.toolCode = toolCode;
		this.toolName = toolName;
