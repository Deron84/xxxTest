...
import com.rail.bo.work.T130300BO;
import com.rail.po.access.RailAccessEmployee;

public class T130300Action extends BaseAction {
	...
	private T130300BO t130300BO = (T130300BO) ContextUtil.getBean("T130300BO");
	public T130300BO getT130300BO() {
		return t130300BO;
	}

	public void setT130300BO(T130300BO t130300BO) {
		t130300BO = t130300BO;
	}
	...
	private String add() throws Exception {
		...
		List<RailAccessEmployee> rwInfos = t130300BO.getByParam(paramMap);
...
//		railAccessEmployee.setMaintainUser(operator.getOprId());
		String rcode=t130300BO.add(railAccessEmployee);
		String msg = "操作失败";
	...
	public String editAccess()throws Exception{
		...
		RailAccessEmployee railAccessEmployee  = t130300BO.getByCode(String.valueOf(getId()));
        if (railAccessEmployee==null) {
            return ErrorCode.T100100_01;
        }
		String rcode = t130300BO.updateAccess(railAccessEmployee);
		String msg = "操作失败";
		boolean success = false;
		if(rcode.equals(Constants.SUCCESS_CODE)){
			success=true;
	...
	public String getData() {
        ...
        try {
        	RailAccessEmployee railAccessEmployee = t130300BO.getByCode(getAccessCode());
            Map<String, Object> midMap = new HashMap<String, Object>();
