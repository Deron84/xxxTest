 ...
 *
 */
public class T130400Action1 extends BaseAction {
	...
	T110100BO t110100BO = (T110100BO) ContextUtil.getBean("T110100BO");
	 ...
	 * @throws Exception
	 */
	public String editPig() throws Exception{

		RailEmployee railEmployee = t110100BO.getByEmpoyeeCode(getEmployeeCode());
		if(railEmployee==null){
			result = ResultUtils.fail("人员不存在");
			log("修改人员头像失败。操作员编号：" + operator.getOprId());
			return  SUCCESS;
		}
...
//	                	result = ResultUtils.fail("必须为图片类型");
//	        			log("修改人员头像失败。操作员编号：" + operator.getOprId());
//	        			return  SUCCESS;
//	                }
...
//			midMap.put("msg", msg);
//			log("修改人员头像成功。操作员编号：" + operator.getOprId());
//		}else{
////			midMap.put("success", false);
////			midMap.put("msg", "人员不存在");
//			result = ResultUtils.fail("人员不存在");
//			log("修改人员头像失败。操作员编号：" + operator.getOprId());
//		}
////
