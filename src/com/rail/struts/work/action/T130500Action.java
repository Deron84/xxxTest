...
public class T130500Action  extends BaseAction {
	...
	//门禁信息维护
	private T130500BO t130500BO = (T130500BO) ContextUtil.getBean("T130500BO");
	public T130500BO getT130500BO() {
		return t130500BO;
	}
	public void setT130500BO(T130500BO t130500bo) {
		t130500BO = t130500bo;
	}
	...
	public String editAccess()throws Exception{
		...
		RailWorkWarn railWorkWarn  = t130500BO.getByCode(String.valueOf(getId()));
        if (railWorkWarn==null) {
            return ErrorCode.T100100_01;
        }
        railWorkWarn.setVerifyMsg(getVerifyMsg());
        railWorkWarn.setInfoSign("1");
        railWorkWarn.setVerifyUser(operator.getOprId());
        railWorkWarn.setVerifyDate(new Date());
		String rcode = t130500BO.updateAccess(railWorkWarn);
		String msg = "操作失败";
	...
	public String getData() {
        ...
        try {
        	RailWorkWarn railWorkWarn = t130500BO.getByCode(getWorkCode());
            Map<String, Object> midMap = new HashMap<String, Object>();
            midMap.put("success", true);
            midMap.put("msg", railWorkWarn);
            String str = JSONObject.toJSONString(midMap);
            PrintWriter printWriter = ServletActionContext.getResponse().getWriter();
            printWriter.write(str);
            printWriter.flush();
